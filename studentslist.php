	...
	// When the user clicks on the button, open the modal
			 $("body").append("<div id='myModal' class='modal'><div class='modal-content'><span class='close'>x</span><p><b> Height<b>" +obj.user.STUDENTID+ " "+obj.user.HEIGHT +"<br><b> Weight <b>"+obj.user.WEIGHT +"</p></div></div>");
