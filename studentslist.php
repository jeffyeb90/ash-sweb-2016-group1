	  ...
	  */
		...
		?>
					...
					include_once("students.php");
					  ...
					  if(isset($_REQUEST['txtSearch'])){
					   searchStudentInfo();
						...
						echo "<div style='overflow-x:auto'><table class='center' id='table'><tr><th>ID</th><th>USER NAME</th><th>FULL NAME</th><th>GENDER</th><th>PHONE NUMBER</th></tr>";
	        ...
	        if($counter%2==1){
							...
							<td onclick=viewDetails(this,{$row['STUDENTID']})><button class='btn'>View More</button></td>
							<td><ahref='editStudentRecord.php?studentID={$row['STUDENTID']}' class='button'>Update</a><br><a href='viewStudentComplaints.php?sid={$row['STUDENTID']}
							'class='button'>View</a><br><a href='medicalComplaintAdd.php?sid={$row['STUDENTID']}' class='button'>Add Medical Complaint</a><br></td>
							</tr>";
							...
							echo "<tr >
								...
								<td>{$row['PHONENUMBER']}</td>
								<td onclick=viewDetails(this,{$row['STUDENTID']})><button class='btn'>View More</button></td>
								<td><a href='editStudentRecord.php?studentID={$row['STUDENTID']}' class='button'>Update</a><br><a href='viewStudentComplaints.php?sid={$row['STUDENTID']}
								'class='button'>View</a><br><a href='medicalComplaintAdd.php?sid={$row['STUDENTID']}' class='button'>Add Medical Complaint</a><br></td>
								</tr>";
